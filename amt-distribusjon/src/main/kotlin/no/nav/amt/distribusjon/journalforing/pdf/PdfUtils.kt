...
private fun HendelseAnsvarlig.getAvsendernavn() =
    when (this) {
...
fun HendelseDeltaker.Deltakerliste.forskriftskapittel() =
    when (this.tiltak.tiltakskode) {
...
fun HendelseDeltaker.Deltakerliste.tittelVisningsnavn() =
    when (this.tiltak.tiltakskode) {
...
private fun InnholdDto.toInnhold() =
    Innhold(
        tekst = tekst,
...
private fun List<Innhold>.toVisingstekster() =
    this.map { innhold ->
...
private fun EndringFraTiltakskoordinator.Avslag.Aarsak.visningsnavn() =
    beskrivelse ?: when (this.type) {
...
private fun Vurderingstype.visningsnavn() =
    when (this) {
