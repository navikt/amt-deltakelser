...
const val OPPGAVE_TEKST =
    "Du har mottatt et utkast til påmelding på arbeidsmarkedstiltaket: %s hos %s. Svar på spørsmålet her."
const val OPPGAVE_TRENGER_GODKJENNING =
    "Du har mottatt et utkast til søknad på arbeidsmarkedstiltaket %s hos %s. Svar på spørsmålet her."
...
fun oppgaveTekst(hendelse: Hendelse): String {
    val tekst =
        if (hendelse.deltaker.deltakerliste.pameldingstype == GjennomforingPameldingType.TRENGER_GODKJENNING) {
