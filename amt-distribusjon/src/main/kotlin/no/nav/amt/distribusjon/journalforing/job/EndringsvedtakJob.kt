...
class EndringsvedtakJob(
    ...
    fun startJob() = jobManager.startJob(
        ...
        period = environment.endringsvedtakJobPeriod,
    ) {
    ...
    suspend fun journalforEndringsvedtak() {
        ...
        endringsvedtakPrDeltaker.forEach { (deltakerId, hendelser) ->
            ...
            if (nyesteHendelseOpprettet.hendelse.opprettet.isBefore(LocalDateTime.now() - environment.endringsvedtakJobGracePeriod)) {
