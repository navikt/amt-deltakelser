...
class VarselTest {
    ...
    inner class OpprettUtkastTests {
        ...
        @Test
        fun `opprettUtkast - hendelsen er håndtert tidligere - sender ikke nytt varsel`() =
            integrationTest { app, _ ->
                val hendelse = Hendelsesdata.lagHendelseDto(HendelseTypeData.opprettUtkast())
                val forrigeVarsel =
                    Varselsdata.varsel(
    ...
    inner class NavGodkjennUtkastTests {
        ...
        @Test
        fun `navGodkjennUtkast - innbyggers er under manuell oppfolging - oppretter ikke varsel`() =
            integrationTest { app, _ ->
                val hendelse =
                    Hendelsesdata.hendelse(
        ...
        @Test
        fun `navGodkjennUtkast - ingen tidligere varsel - oppretter beskjed`() =
            integrationTest { app, _ ->
        ...
        @Test
        fun `navGodkjennUtkast - tidligere varsel - inaktiverer varsel og oppretter beskjed`() =
            integrationTest { app, _ ->
                val hendelse = Hendelsesdata.lagHendelseDto(HendelseTypeData.navGodkjennUtkast())
    ...
    @Test
    fun `avbrytUtkast - varsel er aktivt - inaktiverer varsel og produserer`() =
        integrationTest { app, _ ->
    ...
    @Test
    fun `innbyggerGodkjennerUtkast - inaktiverer varsel`() =
        integrationTest { app, _ ->
    ...
    @Test
    fun `endreSluttdato - ingen tidligere varsel - oppretter forsinket varsel`() =
        integrationTest { app, _ ->
    ...
    @Test
    fun `endreStartdato - ingen tidligere varsel - oppretter forsinket varsel`() =
        integrationTest { app, _ ->
    ...
    inner class DeltakerSistBesoktTests {
        @Test
        fun `deltakerSistBesokt - aktiv beskjed - inaktiverer`() =
            integrationTest { app, _ ->
        ...
        @Test
        fun `deltakerSistBesokt - beskjed venter på å bli sendt - inaktiverer`() =
            integrationTest { app, _ ->
                val hendelse = Hendelsesdata.lagHendelseDto(HendelseTypeData.sistBesokt())
                val varsel =
                    Varselsdata.varsel(
        ...
        @Test
        fun `deltakerSistBesokt - to beskjeder, en aktiv og en venter - inaktiverer begge`() =
            integrationTest { app, _ ->
                val hendelse = Hendelsesdata.lagHendelseDto(HendelseTypeData.sistBesokt())
                val aktivtVarsel =
                    Varselsdata.varsel(
