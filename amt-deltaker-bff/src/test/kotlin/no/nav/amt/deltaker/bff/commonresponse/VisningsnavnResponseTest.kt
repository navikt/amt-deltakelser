...
class VisningsnavnResponseTest {
    ...
    companion object {
        ...
        fun specCases(): Stream<SpecCase> = Stream.of(
            ...
            SpecCase(
                navn = "enkeltplass arbeidsmarkedsopplaering bruker tiltakstypen i tittel",
                tiltakskode = Tiltakskode.ENKELTPLASS_ARBEIDSMARKEDSOPPLAERING,
                type = GjennomforingType.Enkeltplass,
                tiltaksnavn = "Arbeidsmarkedsopplæring (enkeltplass)",
                gjennomforingsnavn = "Deltakerliste navn",
                arrangorNavn = "Arrangør navn",
                forventetTittel = "Arbeidsmarkedsopplæring (enkeltplass) hos Arrangør navn",
                forventetIngress = null,
                forventetKladd = null,
            ),
            SpecCase(
                navn = "enkeltplass fag og yrkesopplaering bruker full tiltakstype i tittel",
                tiltakskode = Tiltakskode.ENKELTPLASS_FAG_OG_YRKESOPPLAERING,
                type = GjennomforingType.Enkeltplass,
                tiltaksnavn = "Fag- og yrkesopplæring eller fagskole (enkeltplass uten rammeavtale)",
                gjennomforingsnavn = "Deltakerliste navn",
                arrangorNavn = "Arrangør navn",
                forventetTittel = "Fag- og yrkesopplæring eller fagskole (enkeltplass uten rammeavtale) hos Arrangør navn",
                forventetIngress = null,
                forventetKladd = null,
            ),
            SpecCase(
