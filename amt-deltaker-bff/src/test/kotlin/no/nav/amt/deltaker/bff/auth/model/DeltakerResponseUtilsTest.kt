...
class DeltakerResponseUtilsTest {
    @Test
    fun `visningsnavn - adressebeskyttet og ikke tilgang - sensurerer navn`() = runTest {
    ...
    @Test
    fun `visningsnavn - adressebeskyttet og tilgang - sensurerer ikke navn`() = runTest {
        with(TiltakskoordinatorTilgangContext()) {
            medFortroligDeltaker()
    ...
    @Test
    fun `visningsnavn - skjermet og ikke tilgang - sensurerer navn`() = runTest {
        with(TiltakskoordinatorTilgangContext()) {
            medSkjermetDeltaker()
    ...
    @Test
    fun `visningsnavn - skjermet og tilgang - sensurerer ikke navn`() = runTest {
        with(TiltakskoordinatorTilgangContext()) {
            medSkjermetDeltaker()
