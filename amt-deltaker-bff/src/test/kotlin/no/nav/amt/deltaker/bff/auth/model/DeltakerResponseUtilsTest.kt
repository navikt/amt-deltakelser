...
class DeltakerResponseUtilsTest {
    @Test
    fun `visningsnavn - adressebeskyttet og ikke tilgang - sensurerer navn`(): Unit =
    ...
    @Test
    fun `visningsnavn - adressebeskyttet og tilgang - sensurerer ikke navn`(): Unit =
        with(TiltakskoordinatorTilgangContext()) {
            medFortroligDeltaker()
    ...
    @Test
    fun `visningsnavn - ikke adressebeskyttet og tilgang - sensurerer ikke navn`(): Unit =
        with(TiltakskoordinatorTilgangContext()) {
            val (fornavn, mellomnavn, etternavn) = deltaker.navBruker.getVisningsnavn(true)
    ...
    @Test
    fun `visningsnavn - skjermet og ikke tilgang - sensurerer navn`(): Unit =
        with(TiltakskoordinatorTilgangContext()) {
            medSkjermetDeltaker()
    ...
    @Test
    fun `visningsnavn - skjermet og tilgang - sensurerer ikke navn`(): Unit =
        with(TiltakskoordinatorTilgangContext()) {
            medSkjermetDeltaker()
    ...
    @Test
    fun `visningsnavn - ikke skjermet og tilgang - sensurerer ikke navn`(): Unit =
        with(TiltakskoordinatorTilgangContext()) {
            val (fornavn, mellomnavn, etternavn) = deltaker.navBruker.getVisningsnavn(true)
