...
import no.nav.amt.deltaker.bff.veileder.api.model.AvsluttDeltakelseRequest
import no.nav.amt.deltaker.bff.veileder.api.model.AvvisForslagRequest
import no.nav.amt.deltaker.bff.veileder.api.model.DeltakerRequest
import no.nav.amt.deltaker.bff.veileder.api.model.DeltakerResponse
import no.nav.amt.deltaker.bff.veileder.api.model.EndreAvslutningRequest
import no.nav.amt.deltaker.bff.veileder.api.model.EndreBakgrunnsinformasjonRequest
import no.nav.amt.deltaker.bff.veileder.api.model.EndreDeltakelsesmengdeRequest
import no.nav.amt.deltaker.bff.veileder.api.model.EndreInnholdRequest
import no.nav.amt.deltaker.bff.veileder.api.model.EndreSluttarsakRequest
import no.nav.amt.deltaker.bff.veileder.api.model.EndreSluttdatoRequest
import no.nav.amt.deltaker.bff.veileder.api.model.EndreStartdatoRequest
import no.nav.amt.deltaker.bff.veileder.api.model.Endringsrequest
import no.nav.amt.deltaker.bff.veileder.api.model.FjernOppstartsdatoRequest
import no.nav.amt.deltaker.bff.veileder.api.model.ForlengDeltakelseRequest
import no.nav.amt.deltaker.bff.veileder.api.model.IkkeAktuellRequest
import no.nav.amt.deltaker.bff.veileder.api.model.ReaktiverDeltakelseRequest
