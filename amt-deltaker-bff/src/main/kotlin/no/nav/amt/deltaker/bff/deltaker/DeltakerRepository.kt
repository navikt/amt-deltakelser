...
class DeltakerRepository {
    ...
    fun upsert(deltaker: Deltaker) {
        ...
        val parameters = mapOf(
            ...
            "historikk" to objectMapper.polymorphicCollectionToPGObject(deltaker.historikk),
    ...
    companion object {
        ...
        private fun rowMapper(row: Row) = Deltaker(
            ...
            navBruker = NavBruker(
                ...
                oppfolgingsperioder = row.stringOrNull("nb.oppfolgingsperioder")?.let { objectMapper.readValue(it) }
                    ?: emptyList(),
