...
object MetricRegister {
    ...
    val MELDT_PA_DIREKTE_UTEN_UTKAST: Counter =
        Counter
            .builder()
    ...
    val MELDT_PA_DIREKTE_MED_UTKAST: Counter =
        Counter
            .builder()
