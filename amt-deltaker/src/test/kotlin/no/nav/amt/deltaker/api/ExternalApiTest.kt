...
import no.nav.amt.deltaker.api.external.HentDeltakelserRequest
import no.nav.amt.deltaker.api.external.response.DeltakelserResponse
import no.nav.amt.deltaker.api.external.response.DeltakerKort
import no.nav.amt.deltaker.api.external.response.DeltakerPersonaliaResponse
