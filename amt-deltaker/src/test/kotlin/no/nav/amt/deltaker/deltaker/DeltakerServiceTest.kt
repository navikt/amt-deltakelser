...
class DeltakerServiceTest {
    ...
    inner class Upsert {
        ...
        fun `har fremtidig status, mottar ny status - inserter ny status, deaktiverer fremtidig status`() =
            runTest {
                ...
                val oppdatertDeltakerFremtidigHarSluttet =
                    opprinneligDeltaker.copy(
                        status =
                            lagDeltakerStatus(
                                statusType = DeltakerStatus.Type.HAR_SLUTTET,
                ...
                val oppdatertDeltakerForlenget =
                    opprinneligDeltaker.copy(
                        status =
                            lagDeltakerStatus(
        ...
        @Test
        fun `har fremtidig status, ny fremtidig status - insert ny fremtidig status, sletter forrige fremtidig status`() =
            runTest {
                val gyldigFra = LocalDateTime.now().plusDays(3)
                val oppdatertDeltakerHarSluttet =
                    opprinneligDeltaker.copy(
                        status =
                            lagDeltakerStatus(
                                statusType = DeltakerStatus.Type.HAR_SLUTTET,
                ...
                val oppdatertDeltakerHarSluttetNyArsak =
                    opprinneligDeltaker.copy(
                        status =
                            lagDeltakerStatus(
                                statusType = DeltakerStatus.Type.HAR_SLUTTET,
    ...
    inner class UpsertDeltakerTests {
        ...
        fun `upsertDeltaker - deltaker endrer status fra kladd til utkast - oppdaterer og publiserer til kafka`() =
            runTest {
                ...
                val deltakerMedOppdatertStatus =
                    deltaker.copy(
                        status = lagDeltakerStatus(DeltakerStatus.Type.UTKAST_TIL_PAMELDING),
                    )
                val vedtak =
                ...
                val oppdatertDeltaker =
                    deltakerMedOppdatertStatus.copy(
    ...
    inner class UpsertEndretDeltakerTests {
        ...
        @Test
        fun `upsertEndretDeltaker - ingen endring - upserter ikke, men godkjenner forslag`() =
            runTest {
                val deltaker =
                    lagDeltaker(
                        sluttdato = LocalDate.now().minusDays(2),
        ...
        @Test
        fun `upsertEndretDeltaker - avslutt i fremtiden - setter fremtidig HAR_SLUTTET`() =
            runTest {
                val deltaker =
                    lagDeltaker(
                        status = lagDeltakerStatus(DeltakerStatus.Type.DELTAR),
        ...
        @Test
        fun `upsertEndretDeltaker - avslutt kursdeltaker i fremtiden - setter fremtidig FULLFORT`() =
            runTest {
                val deltaker =
                    lagDeltaker(
                        status = lagDeltakerStatus(DeltakerStatus.Type.DELTAR),
        ...
        @Test
        fun `upsertEndretDeltaker - avslutt i fremtiden, blir forlenget - deaktiverer fremtidig HAR_SLUTTET`() =
            runTest {
                val deltaker =
                    lagDeltaker(
                        status = lagDeltakerStatus(DeltakerStatus.Type.DELTAR),
        ...
        @Test
        fun `upsertEndretDeltaker - har sluttet, skal delta, avslutt i fremtiden - blir DELTAR, fremtidig HAR_SLUTTET`() =
            runTest {
                val deltaker =
                    lagDeltaker(
                        status = lagDeltakerStatus(DeltakerStatus.Type.HAR_SLUTTET),
        ...
        @Test
        fun `upsertEndretDeltaker - endret deltakelsesmengde - upserter endring`() =
            runTest {
        ...
        @Test
        fun `upsertEndretDeltaker - fremtidig deltakelsesmengde - upserter endring, endrer ikke deltaker`() =
            runTest {
                val deltaker = lagDeltaker()
                val vedtak = lagVedtak(deltakerId = deltaker.id, opprettetAv = endretAv, opprettetAvEnhet = endretAvEnhet)
        ...
        @Test
        fun `upsertEndretDeltaker - endret datoer - upserter endring`() =
            runTest {
                val deltaker =
                    lagDeltaker(
                        status = lagDeltakerStatus(DeltakerStatus.Type.DELTAR),
        ...
        @Test
        fun `upsertEndretDeltaker - endret startdato - upserter ny dato og status`() =
            runTest {
        ...
        @Test
        fun `upsertEndretDeltaker - reaktiver - kladd slettes`() =
            runTest {
                val deltaker =
                    lagDeltaker(
    ...
    inner class UpsertEndretDeltakereTests {
        @Test
        fun `upsertEndretDeltakere - sett på venteliste - upserter endring`() =
            runTest {
                val deltakerliste =
                    lagDeltakerliste(
                ...
                val endredeDeltakere =
                    deltakerService.oppdaterDeltakere(
                        deltakerIder,
                ...
                endredeDeltakere.first { it.deltaker.id == deltaker.id }.deltaker shouldBeComparableWith
                    deltaker.copy(
                ...
                endredeDeltakere
                    ...
                    }.deltaker shouldBeComparableWith
                    deltaker2.copy(
        ...
        @Test
        fun `upsertEndretDeltakere - tildel plass feiler på upsert - ruller tilbake endringer på samme deltaker`() =
            runTest {
                val endretAv = lagNavAnsatt()
                val endretAvEnhet = lagNavEnhet(enhetsnummer = "0326")
                val deltakerliste =
                ...
                val ikkeEndretDeltakerResult =
                    endredeDeltakereResults.first {
                        it.deltaker.id == deltaker2.id
                    }
        ...
        @Test
        fun `upsertEndretDeltakere - tildel plass - upserter endring, bruker deltakerliste sin start og sluttdato`() =
            runTest {
                val deltakerliste =
                    lagDeltakerliste(
                        tiltakstype = lagTiltakstype(tiltakskode = Tiltakskode.GRUPPE_FAG_OG_YRKESOPPLAERING),
        ...
        @Test
        fun `upsertEndretDeltakere - tildel plass - upserter endring, dato passert får start og sluttdato null`() =
            runTest {
                val deltakerliste =
                    lagDeltakerliste(
                        tiltakstype = lagTiltakstype(tiltakskode = Tiltakskode.GRUPPE_FAG_OG_YRKESOPPLAERING),
        ...
        @Test
        fun `upsertEndretDeltakere - tildel plass feiler på siste deltaker - ruller tilbake en deltaker`() =
            runTest {
                val deltakerliste =
                    lagDeltakerliste(
                        tiltakstype = lagTiltakstype(tiltakskode = Tiltakskode.GRUPPE_FAG_OG_YRKESOPPLAERING),
        ...
        @Test
        fun `upsertEndretDeltakere - del med arrangør - inserter endring og returnerer endret deltaker`() =
            runTest {
                val deltakerliste =
                    lagDeltakerliste(
                        tiltakstype =
    ...
    inner class TransactionalDeltakerUpsertTests {
        @Test
        fun `ny deltaker - returnerer deltaker`() =
            runTest {
        ...
        @Test
        fun `ny deltaker - ruller tilbake alle endringer`() =
            runTest {
                val deltakerliste =
                    lagDeltakerliste(
                        tiltakstype = lagTiltakstype(tiltakskode = Tiltakskode.GRUPPE_FAG_OG_YRKESOPPLAERING),
                ...
                val upsertResult =
                    deltakerService.transactionalDeltakerUpsert(expectedDeltaker, false) {
        ...
        @Test
        fun `ny status, siste insert feiler - ruller tilbake alle endringer`() =
            runTest {
                val deltakerliste =
                    lagDeltakerliste(
    ...
    @Test
    fun `giAvslag - deltaker får riktig status og historikk`() =
        runTest {
            with(EndringFraTiltakskoordinatorCtx()) {
                ...
                val avslag =
                    EndringFraTiltakskoordinator.Avslag(
                        aarsak =
                            EndringFraTiltakskoordinator.Avslag.Aarsak(
...
infix fun Deltaker.shouldBeComparableWith(expected: Deltaker?) {
    val statusOpprettetDay =
        this.status.opprettet
            .toLocalDate()
            .atStartOfDay()
    val gyldigFra =
        this.status.gyldigFra
            .toLocalDate()
            .atStartOfDay()
