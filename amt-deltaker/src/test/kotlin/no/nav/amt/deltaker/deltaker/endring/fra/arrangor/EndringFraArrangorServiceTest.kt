...
class EndringFraArrangorServiceTest {
    ...
    private val endringFraArrangorService =
    ...
    @Test
    fun `upsertEndretDeltaker - legg til oppstartsdato, dato ikke passert - inserter endring og returnerer deltaker`() =
        runTest {
            val deltaker =
                lagDeltaker(
                    startdato = null,
    ...
    @Test
    fun `upsertEndretDeltaker - legg til oppstartsdato, dato passert - inserter endring og returnerer deltaker`() =
        runTest {
            val deltaker =
                lagDeltaker(
                    startdato = null,
    ...
    @Test
    fun `upsertEndretDeltaker - legg til oppstartsdato uten sluttdato, dato passert - inserter endring og returnerer deltaker`() =
        runTest {
            val deltaker =
                lagDeltaker(
                    startdato = null,
    ...
    @Test
    fun `upsertEndretDeltaker - legg til oppstartsdato uten sluttdato - fjerner ikke eksisterende sluttdato`() =
        runTest {
    ...
    @Test
    fun `upsertEndretDeltaker - legg til oppstartsdato, start- og sluttdato passert - inserter endring og returnerer deltaker`() =
        runTest {
            val deltaker =
                lagDeltaker(
                    startdato = null,
