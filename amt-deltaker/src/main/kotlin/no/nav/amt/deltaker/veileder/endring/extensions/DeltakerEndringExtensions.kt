...
fun DeltakerEndring.Endring.anvendPaaDeltaker(
    ...
    when (this) {
        ...
        is DeltakerEndring.Endring.AvbrytDeltakelse -> handleEndring(
            deltaker = deltaker,
        ...
        is DeltakerEndring.Endring.EndreBakgrunnsinformasjon -> handleEndring(
            deltaker = deltaker,
        ...
        is DeltakerEndring.Endring.EndreStartdato -> handleEndring(
            deltaker = deltaker,
        ...
        is DeltakerEndring.Endring.ForlengDeltakelse -> handleEndring(
            deltaker = deltaker,
        ...
        is DeltakerEndring.Endring.IkkeAktuell -> handleEndring(
            deltaker = deltaker,
            hasChanges = DeltakerEndring.Endring.IkkeAktuell::hasChanges,
            apply = DeltakerEndring.Endring.IkkeAktuell::ikkeAktuell,
        )

        is DeltakerEndring.Endring.ReaktiverDeltakelse -> handleEndring(
            deltaker = deltaker,
        ...
        is DeltakerEndring.Endring.FjernOppstartsdato -> handleEndring(
            deltaker = deltaker,
...
): VellykketEndring = if (hasChanges(deltaker)) {
    apply(deltaker)
} else {
