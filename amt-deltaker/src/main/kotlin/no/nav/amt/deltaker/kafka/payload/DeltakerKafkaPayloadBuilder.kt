package no.nav.amt.deltaker.kafka.payload

import no.nav.amt.deltaker.extensions.getStatustekst
...
class DeltakerKafkaPayloadBuilder(
    ...
    private fun DeltakerHistorikk.getSistEndretAv(): UUID = when (this) {
        ...
        is DeltakerHistorikk.EnkeltplasstOkonomiGodkjent -> data.sistEndretAvNavAnsattId
    ...
    private fun DeltakerHistorikk.getSistEndretAvEnhet(): UUID? = when (this) {
        ...
        is DeltakerHistorikk.EnkeltplasstOkonomiGodkjent -> data.sistEndretAvNavEnhetId
