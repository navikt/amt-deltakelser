package tjenester.nav.veilarboppfolging
...
import tjenester.nav.nom.NomVeilederOption
...
fun HTML.veilarboppfolgingPersonFormPage(
    ...
    veilederOptions: List<NomVeilederOption>,
) {
    head {
...
private fun FORM.veilederField(options: List<NomVeilederOption>, selectedValue: String) {
    div("field") {
        label { +"Veilederident" }
        select {
            name = "veilederIdent"
