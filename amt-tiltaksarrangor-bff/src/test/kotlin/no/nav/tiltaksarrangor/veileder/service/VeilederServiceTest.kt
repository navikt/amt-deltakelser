...
class VeilederServiceTest(
    ...
    @Nested
    inner class GetMineDeltakereTests {
        @Test
        ...
        @Test
        fun `ansatt er veileder for tre deltakere hos to arrangorer - returnerer riktige deltakere med endringsmeldinger`() {
            val personIdent = "12345678910"
        ...
        @Test
        fun `ansatt er veileder for deltakere med sluttdato mer enn 41 dager frem i tid - filtrerer bort skjulte deltakere`() {
            val personIdent = "12345678910"
            val arrangorId = UUID.randomUUID()
            val deltakerliste = getDeltakerliste(arrangorId)
            deltakerlisteRepository.insertOrUpdateDeltakerliste(deltakerliste)
