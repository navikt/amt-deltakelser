...
class KafkaConsumerService(
    ...
    fun lagreNyDeltakerUlestEndring(
    ...
    private fun lagreNyDeltakerUlestEndringForTiltakskoordinatorEndring(
    ...
    private fun hentUlesteEndringerFraHistorikk(
        lagretDeltaker: DeltakerDbo,
        nyDeltaker: DeltakerKafkaPayload,
    ): List<Oppdatering> = nyDeltaker.historikk
        ?.toSet()
    ...
    private fun mapToTiltakskoordinatorOppdatering(
        endring: EndringFraTiltakskoordinator,
        erNyDeltaker: Boolean,
    ): Oppdatering? = when (val e = endring.endring) {
