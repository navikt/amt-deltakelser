...
class KoordinatorService(
    ...
    private fun getDeltakerliste(
        deltakerlisteMedArrangor: DeltakerlisteMedArrangorDbo,
        ansattId: UUID,
    ): Deltakerliste {
    ...
    private fun tilKoordinatorsDeltakere(
        ...
        Deltaker(
            ...
            oppdateringFraNav = ulesteEndringer.any { ulestEndring ->
                ulestEndring.deltakerId == deltaker.id &&
                    ulestEndring.erOppdateringFraNav()
            },
    ...
    ): List<Veileder> = veiledereDeltakere.filter {
        it.deltakerId == deltakerId
    }

    private fun erVeilederForDeltaker(
        ansattId: UUID,
        veiledereDeltakere: List<Veileder>,
    ): Boolean = veiledereDeltakere.find {
