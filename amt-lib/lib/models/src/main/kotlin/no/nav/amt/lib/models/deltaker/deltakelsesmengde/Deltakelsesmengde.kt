...
fun DeltakerEndring.Endring.EndreDeltakelsesmengde.toDeltakelsesmengde(opprettet: LocalDateTime) =
    Deltakelsesmengde(
...
fun Vedtak.toDeltakelsesmengde() =
    this.deltakerVedVedtak.deltakelsesprosent?.let {
        Deltakelsesmengde(
...
fun ImportertFraArena.toDeltakelsesmengde() =
    this.deltakerVedImport.deltakelsesprosent?.let {
        Deltakelsesmengde(
