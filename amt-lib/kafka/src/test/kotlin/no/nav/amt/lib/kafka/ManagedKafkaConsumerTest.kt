...
class ManagedKafkaConsumerTest {
    @Test
    fun `ManagedKafkaConsumer - konsumerer record med String, String`() = runTest {
        val key = "key"
        val value = "value"
    ...
    @Test
    fun `ManagedKafkaConsumer - konsumerer record med UUID, ByteArray`() = runTest {
    ...
    @Test
    fun `ManagedKafkaConsumer - prøver å konsumere melding på nytt hvis noe feiler`() = runTest {
